...
function Debounceinput_ab14cf2acc6e00704a0fc627c66b78c5 () {
  const reflex___state____state__spendee___app_state____app_state = useContext(StateContexts.reflex___state____state__spendee___app_state____app_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_change_69ed45f51ca5fcd0742d0638c57c6350 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.spendee___app_state____app_state.set_c_name", ({ ["value"] : _e?.["target"]?.["value"] }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx(DebounceInput,{css:({ ["width"] : "100%" }),debounceTimeout:300,element:RadixThemesTextField.Root,onChange:on_change_69ed45f51ca5fcd0742d0638c57c6350,placeholder:"VD: \u0102n u\u1ed1ng, L\u01b0\u01a1ng...",value:(isNotNullOrUndefined(reflex___state____state__spendee___app_state____app_state.c_name_rx_state_) ? reflex___state____state__spendee___app_state____app_state.c_name_rx_state_ : "")},)
  )
}


function Select__root_539447c27b45b091c9a98906adb2b934 () {
  const reflex___state____state__spendee___app_state____app_state = useContext(StateContexts.reflex___state____state__spendee___app_state____app_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_change_812cacf01182597b523414bbddf06ab7 = useCallback(((_ev_0) => (addEvents([(ReflexEvent("reflex___state____state.spendee___app_state____app_state.set_c_type", ({ ["value"] : _ev_0 }), ({  })))], [_ev_0], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx(RadixThemesSelect.Root,{onValueChange:on_change_812cacf01182597b523414bbddf06ab7,value:reflex___state____state__spendee___app_state____app_state.c_type_rx_state_},jsx(RadixThemesSelect.Trigger,{css:({ ["width"] : "100%" }),placeholder:"Ch\u1ecdn lo\u1ea1i"},),jsx(RadixThemesSelect.Content,{},jsx(RadixThemesSelect.Item,{value:"EXPENSE"},"Chi ti\u00eau"),jsx(RadixThemesSelect.Item,{value:"INCOME"},"Thu nh\u1eadp")))
  )
}


function Select__root_06d6fca29de0102da64a32cbb3efd51b () {
  const reflex___state____state__spendee___app_state____app_state = useContext(StateContexts.reflex___state____state__spendee___app_state____app_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_change_c2ff20fedb8f1ecf88e0884d9698bdf0 = useCallback(((_ev_0) => (addEvents([(ReflexEvent("reflex___state____state.spendee___app_state____app_state.set_c_icon", ({ ["value"] : _ev_0 }), ({  })))], [_ev_0], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx(RadixThemesSelect.Root,{onValueChange:on_change_c2ff20fedb8f1ecf88e0884d9698bdf0,value:reflex___state____state__spendee___app_state____app_state.c_icon_rx_state_},jsx(RadixThemesSelect.Trigger,{css:({ ["width"] : "100%" }),placeholder:"Ch\u1ecdn bi\u1ec3u t\u01b0\u1ee3ng"},),jsx(RadixThemesSelect.Content,{},jsx(RadixThemesSelect.Item,{value:"utensils"},"\u0102n u\u1ed1ng"),jsx(RadixThemesSelect.Item,{value:"car"},"Di chuy\u1ec3n"),jsx(RadixThemesSelect.Item,{value:"shopping-cart"},"Mua s\u1eafm"),jsx(RadixThemesSelect.Item,{value:"home"},"Nh\u00e0 c\u1eeda"),jsx(RadixThemesSelect.Item,{value:"file-invoice-dollar"},"H\u00f3a \u0111\u01a1n"),jsx(RadixThemesSelect.Item,{value:"money-bill-wave"},"Ti\u1ec1n l\u01b0\u01a1ng"),jsx(RadixThemesSelect.Item,{value:"gamepad"},"Gi\u1ea3i tr\u00ed")))
  )
}


function Select__root_ab8c9106dfecc8f786ab27ba2092db09 () {
  const reflex___state____state__spendee___app_state____app_state = useContext(StateContexts.reflex___state____state__spendee___app_state____app_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_change_580ee584348b456f940e0bcbec6ddfa3 = useCallback(((_ev_0) => (addEvents([(ReflexEvent("reflex___state____state.spendee___app_state____app_state.set_c_color", ({ ["value"] : _ev_0 }), ({  })))], [_ev_0], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx(RadixThemesSelect.Root,{onValueChange:on_change_580ee584348b456f940e0bcbec6ddfa3,value:reflex___state____state__spendee___app_state____app_state.c_color_rx_state_},jsx(RadixThemesSelect.Trigger,{css:({ ["width"] : "100%" }),placeholder:"Ch\u1ecdn m\u00e0u s\u1eafc"},),jsx(RadixThemesSelect.Content,{},jsx(RadixThemesSelect.Item,{value:"#ff4757"},"\u0110\u1ecf"),jsx(RadixThemesSelect.Item,{value:"#00c6ff"},"Xanh d\u01b0\u01a1ng"),jsx(RadixThemesSelect.Item,{value:"#00e676"},"Xanh l\u00e1"),jsx(RadixThemesSelect.Item,{value:"#ffa502"},"Cam"),jsx(RadixThemesSelect.Item,{value:"#9b59b6"},"T\u00edm"),jsx(RadixThemesSelect.Item,{value:"#fd79a8"},"H\u1ed3ng")))
  )
}


function Button_abf83c75bdb8f85a61e59aec7a1d0383 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_click_a48250ef6a4cfc0763b3d391ce681f43 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.spendee___app_state____app_state.create_category", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx(RadixThemesButton,{css:({ ["background"] : "linear-gradient(45deg, #00c6ff, #0072ff)", ["color"] : "white", ["border"] : "none", ["width"] : "100%", ["marginTop"] : "4" }),onClick:on_click_a48250ef6a4cfc0763b3d391ce681f43,variant:"solid"},"Th\u00eam danh m\u1ee5c")
  )
}


function Table__body_c265293f30d52b80fd3485a64614c883 () {
  const reflex___state____state__spendee___app_state____app_state = useContext(StateContexts.reflex___state____state__spendee___app_state____app_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);
  ...
  return (
    jsx(RadixThemesTable.Body,{},Array.prototype.map.call(reflex___state____state__spendee___app_state____app_state.categories_rx_state_ ?? [],((c_rx_state_,index_babbd5a0ccc1bf5336f759bd8ac8b10b)=>(jsx(RadixThemesTable.Row,{css:({ ["&:hover"] : ({ ["background"] : "rgba(255,255,255,0.1)" }) }),key:index_babbd5a0ccc1bf5336f759bd8ac8b10b},jsx(RadixThemesTable.Cell,{css:({ ["color"] : "#fff", ["borderBottom"] : "1px solid rgba(255,255,255,0.05)" })},jsx(DynamicIcon,{css:({ ["color"] : c_rx_state_?.["color"] }),name:c_rx_state_?.["icon"].replaceAll("_", "-"),size:20},)),jsx(RadixThemesTable.RowHeaderCell,{css:({ ["color"] : "#fff", ["borderBottom"] : "1px solid rgba(255,255,255,0.05)" })},c_rx_state_?.["name"]),jsx(RadixThemesTable.Cell,{css:({ ["color"] : "#fff", ["borderBottom"] : "1px solid rgba(255,255,255,0.05)" })},jsx(Fragment,{},((c_rx_state_?.["type"]?.valueOf?.() === "EXPENSE"?.valueOf?.())?(jsx(Fragment,{},jsx(RadixThemesText,{as:"p",css:({ ["color"] : "#ff4757", ["fontWeight"] : "500" })},"Chi ti\u00eau"))):(jsx(Fragment,{},jsx(RadixThemesText,{as:"p",css:({ ["color"] : "#00e676", ["fontWeight"] : "500" })},"Thu nh\u1eadp")))))),jsx(RadixThemesTable.Cell,{css:({ ["color"] : "#fff", ["borderBottom"] : "1px solid rgba(255,255,255,0.05)" })},c_rx_state_?.["transaction_count"]),jsx(RadixThemesTable.Cell,{css:({ ["color"] : "#fff", ["borderBottom"] : "1px solid rgba(255,255,255,0.05)" })},jsx(RadixThemesButton,{color:"red",onClick:((_e) => (addEvents([(ReflexEvent("reflex___state____state.spendee___app_state____app_state.delete_category", ({ ["cat_id"] : c_rx_state_?.["id"] }), ({  })))], [_e], ({  })))),size:"1",variant:"soft"},"X\u00f3a")))))))
  )
}
